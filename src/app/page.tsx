    ...
    return (
        <div className={'flex justify-between items-center text-dark w-full h-full min-h-screen'}>
            <div className={'w-1/2 flex justify-center'}>
                <Image src={'/images/profile/developer-pic-1.png'} alt={'profile'} width={'500'} height={'500'}/>
            </div>
                ...
                <div className={'flex items-center self-start mt-2'}>
                    <Link
                        ...
                        className={'flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold ' +
                            'hover:bg-light hover:text-dark border-2 boder-solid border-transparent hover:border-dark'}
                        download={true}
                    ...
                    <Link
                        ...
                        className={'ml-4 flex items-center bg-light text-primary p-2.5 px-6 rounded-lg text-lg font-semibold ' +
                            'hover:bg-primary hover:text-light border-2 boder-solid border-primary hover:border-tranparent'}
                        download={true}
